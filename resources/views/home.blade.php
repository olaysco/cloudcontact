    ...
    <div class="container-fluid">
      ...
      <div class="navbar-collapse collapse" id="sidenav-collapse-main" style="">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="/new-contact">
         ...
         @endif
          <div class="card bg-default shadow">
            ...
            <div class="table-responsive">
              <!-- Projects table -->
              @if ($contacts->isEmpty())
              <p style="margin-left:10px; color:#FFF;"> Empty contact . <a class="nav-link" href="/new-contact">
              <i class="fa fa-plus text-blue"></i>Add Contact</a> </p>
              @else
              <table class="table align-items-center table-flush table-dark">
                ...
                @foreach($contacts as $contact)
                  ...
                  <tr>
                    ...
                    <td>
                       {!! $contact->work_phone !!} <i class="fas fa-caret-down mr-3"></i>
                    </td>
                  </tr>
                  @endforeach
